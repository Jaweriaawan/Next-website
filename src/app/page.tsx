...
export default function Intro(){
  return <div className="font-sans">
    ...
    <Header />
    <div className="w-[400px] h-[200px] bg-black absolute mt-[-600px] ml-[600px] opacity-65 text-center pt-[40px]">
    ...
    <div className="w-[400px] h-[230px] ml-[600px] bg-black mt-[-450px] absolute opacity-65 px-[15px] pt-[30px]">
