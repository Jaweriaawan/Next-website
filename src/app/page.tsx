...
export default function Intro(){
  return <div className="font-sans">
    ...
    <div className="w-[400px] h-[230px] ml-[600px] bg-black mt-[-300px] absolute opacity-65 px-[15px] pt-[30px]">
    ...
    <div className="w-[250px] h-[60px] bg-black opacity-75 mt-[-150px] ml-[680px] text-[#C4A484] flex px-[40px] text-center pt-[13px] gap-[15px]">
