...
export default function Intro(){
  return <div className="font-sans">
    ...
    <Header />
    <div className="w-[400px] h-[200px] bg-black absolute mt-[-780px] ml-[600px] opacity-65 text-center pt-[40px]">
    ...
    <div className="w-[250px] h-[60px] bg-black opacity-75 mt-[-295px] ml-[730px] text-[#C4A484] flex px-[40px] text-center pt-[13px] gap-[15px]">
