...
export default function Intro(){
  return <div className="font-sans">
    ...
    <Header />
    <div className="w-[400px] h-[200px] bg-black absolute mt-[-700px] ml-[720px] opacity-65 text-center pt-[40px]">
    ...
    <div className="w-[400px] h-[230px] ml-[720px] bg-black mt-[-480px] absolute opacity-65 px-[15px] pt-[30px]">
    ...
    <div className="w-[250px] h-[60px] bg-black opacity-75 mt-[-230px] ml-[790px] text-[#C4A484] flex px-[40px] text-center pt-[13px] gap-[15px]">
