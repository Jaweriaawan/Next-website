...
export default function Intro(){
  return <div className="font-sans">
    ...
    <Header />
    <div className="w-[400px] h-[200px] bg-black absolute mt-[-580px] ml-[600px] opacity-65 text-center pt-[40px]">
    ...
    <div className="w-[400px] h-[230px] ml-[600px] bg-black mt-[-700px] absolute opacity-65 px-[15px] pt-[30px]">
    ...
    <div className="w-[250px] h-[60px] bg-black opacity-75 mt-[-180px] ml-[680px] text-[#C4A484] flex px-[40px] text-center pt-[13px] gap-[15px]">
